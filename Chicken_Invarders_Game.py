...
def game_loop():
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            #In loop just check a action (pressed or released,...)
            #If keystroke is pressed check whether its right or left
            if event.type == pygame.KEYDOWN:#print("Keystroke is press")
                if event.key==pygame.K_r:#print("Left arrow is pressed")
                    return True
